...
| --------- | ------ | ----- |
| Display | :heavy_check_mark: |  - VRR works from GNOME 46 (tested on Fedora Workstation 40) <br><br> - HDR does NOT work in browsers, atleast in my case <br><br> - HDR "out of the box" doesn't work in every media player or games <br><br> - HDR works with Proton-GE on Heroic launcher (confirmed myself). Should probably work in steam too with the right settings <br><br> - HDR works in mpv  <br><br> - Displays colors by default are good enough. <br><br> - [Disable AMD Vari Bright](https://github.com/realKarthikNair/16-xf0xxx-linux-troubleshooting/blob/main/disable-amd-Vari-Bright.md) (THIS IS NECESSARY if you care about color accuracy on battery power) | 
